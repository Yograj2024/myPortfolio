  ...
  return <>
    <div className ="space-y-8 pt-[1rem] h-full">
      ...
      <div className ={` ${theme == "dark" ? "bg-[#0A1222]" : "bg-[#ffffff] text-purple-600"} ani-smooth p-4 rounded-lg shadow-lg`}>
        <h3 className ={`text-[1.125rem] pl-[1.5rem] md:text-[1.5rem] font-semibold mb-2 relative`}>
          <span className ={`absolute top-[55%] shadow-[0_0_5px_3px_rgba(0,0,0,0.6)] shadow-red-400 -translate-y-[50%] left-0 inline-block h-[1rem] aspect-square bg-yellow-400 rounded-full animate-pulse`}></span>
          Open to Freelance Opportunities
        </h3>
        <p className ={`text-gray-400 text-[0.9rem] md:text-[1rem]`}>
          I’m open to freelance projects in Front-End Development, specializing in React.js, UI/UX design, and responsive web applications. I enjoy turning ideas into smooth, engaging, and user-friendly experiences. If you’re looking for a creative and reliable front-end developer, let’s connect!”
        </p>
      </div>
    </div>
