...
const ProjectDetails = ({project}) => {
    ...
    return <div className ={` h-0 w-full overflow-hidden px-[1rem] absolute bottom-0 scale-95 opacity-0
    beforeCon before:top-0 before:right-0 transition-all duration-400 ease-in-out 
    group-hover:h-full group-hover:py-[1rem] group-hover:scale-100 group-hover:opacity-100 
    `}>
