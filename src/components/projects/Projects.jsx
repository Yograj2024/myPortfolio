...
const projects = [
  {
    ...
    project : <NetflixGPT/>,
    projectDetail : <ProjectDetails project = {gptDetails} />,
    ...
    hi:[ { text : "लाइव डेमो", ...projectBtns.liveDemo}, { text : "सोर्स कोड",    ...projectBtns.gitHub} ],
    mr:[ { text : "थेट डेमो",   ...projectBtns.liveDemo}, { text : "स्रोत कोड",    ...projectBtns.gitHub} ],
    en:[ { text : "live demo",...projectBtns.liveDemo}, { text : "source code", ...projectBtns.gitHub} ],
  },
]
